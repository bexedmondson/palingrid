...
@export var toggle_clip_contents : bool = true:
	set = set_toggle_clip_contents, get = get_toggle_clip_contents
...
## Returns [member toggle_clip_contents]
func get_toggle_clip_contents() -> bool:
	return toggle_clip_contents
...
## Setter for [member toggle_clip_contents].
func set_toggle_clip_contents(start_clip : bool) -> void:
	toggle_clip_contents = start_clip
...
func _change(open: bool, tweening: bool) -> void:
	...
	if get_toggle_clip_contents():
		self.clip_contents = !self.clip_contents
